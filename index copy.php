...
// Check if the user is logged in (You can adjust this as per your authentication logic)
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href=".">
                <img src="assets/<?php echo $web_logo;?>" alt="Logo"> <!-- Replace with your logo path -->
                <?php echo $web_name;?>
            </a>
    ...
    <!-- Main Content -->
    <main role="main" class="containerr">
        <?php include $file; ?>
    </main>
    ...
    <footer class="bg-light text-center py-3" style=" position: absolute; bottom: 0; width: 100%; ">
        <div class="container">
            <p class="mb-0">© <?php echo date('Y'); ?> <?php echo $web_name;?>. All rights reserved.</p>
        </div>
    </footer>
